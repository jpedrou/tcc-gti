...
from PyQt5.QtWidgets import QTableWidgetItem, QApplication, QTableWidgetItem, QMessageBox
...
from sklearn.model_selection import KFold, train_test_split       #Using Skicit-learn to split data into training and testing sets
...
class smart_map:
    ...
    def run(self):
        ...
        if self.path_absolute == './':  #there is no open QGIS project 
            ...
            self.maximum_points_plugin = 18000                              #max samples points to plugin work 
...
############################################################    Data import tab #################################################################
    ...
    def load_datatable_atribute_table(self): 
        ...
        # Melhoria do carregamento dos dados
            ...
            if (lyrCRS.isGeographic() == True):  #layer é lat/long
                ...
                if continue_prossessing == 'YES': 
                    ...
                    if ((self.Cord_X not in cols_df) and (self.Cord_Y not in cols_df)):   
                        ...
                        self.df.to_csv(os.path.join(self.path_absolute , '0_Dados.csv'))
                    ...
                    if len(self.df) > self.maximum_points_plugin * 1.2: 
                        ...
                        if message == QMessageBox.Yes:
                            ...
                            self.df.to_csv(os.path.join(self.path_absolute , '0_Dados_Resample.csv'))
...
############################################################    Aba para definir zonas de manejo utilizando cluster  #################################################################
    ...
    def define_raster_color_ramp(self, layer, Output_Layer_Name):
        ...
        if number_classes == 2: 
            ...
            #if '3.28' in qgis_version:    #for version 3.28 
            ...
            #else: #para versões anteriores a versão 3.28
